...
namespace TestServiceLayer.Services
{
    ...
    public class BookServiceTests
    {
        ...
        [TestMethod]
        public async Task FindByTitleAsync_ValidTitle_ShouldReturnMatchingBooks()
        {
            // Arrange
            var title = "Great";
            var books = _fixture.CreateMany<Book>(2).ToList();

            _bookRepositoryMock.Setup(r => r.FindByTitleAsync(title))
                .ReturnsAsync(books);

            // Act
            var result = await _service.FindByTitleAsync(title);
        ...
        [TestMethod]
        public async Task FindByTitleAsync_EmptyTitle_ShouldReturnValidationError()
        {
            // Arrange
            var title = "";
            ...
            result.Success.Should().BeFalse();
            result.ValidationErrors.Should().ContainSingle()
                .Which.Should().Contain("Title cannot be empty");
        }

        [TestMethod]
        public async Task FindByTitleAsync_WhitespaceTitle_ShouldReturnValidationError()
        {
            // Arrange
            var title = "   ";
        ...
        #region FindByDomainAsync Tests

        [TestMethod]
        public async Task FindByDomainAsync_ValidDomain_ShouldReturnBooks()
        {
            // Arrange
            ...
            _domainRepositoryMock.Setup(r => r.GetByIdAsync(domainId))
                .ReturnsAsync(domain);
            _bookRepositoryMock.Setup(r => r.FindByDomainAsync(domainId))
                .ReturnsAsync(books);

            // Act
            var result = await _service.FindByDomainAsync(domainId);
        ...
        [TestMethod]
        public async Task FindByDomainAsync_DomainNotFound_ShouldReturnNotFoundError()
        {
            // Arrange
            var domainId = Guid.NewGuid();
            _domainRepositoryMock.Setup(r => r.GetByIdAsync(domainId))
        ...
        #region FindByAuthorAsync Tests

        [TestMethod]
        public async Task FindByAuthorAsync_ValidAuthor_ShouldReturnBooks()
        {
            // Arrange
            ...
            _unitOfWorkMock.Setup(u => u.Authors).Returns(authorRepositoryMock.Object);

            authorRepositoryMock.Setup(r => r.GetByIdAsync(authorId))
                .ReturnsAsync(author);
            _bookRepositoryMock.Setup(r => r.FindByAuthorAsync(authorId))
                .ReturnsAsync(books);

            // Act
            var result = await _service.FindByAuthorAsync(authorId);
        ...
        [TestMethod]
        public async Task FindByAuthorAsync_AuthorNotFound_ShouldReturnNotFoundError()
        {
            // Arrange
            var authorId = Guid.NewGuid();
            var authorRepositoryMock = new Mock<IAuthorRepository>();
        ...
        #region GetAvailableForBorrowingAsync Tests

        [TestMethod]
        public async Task GetAvailableForBorrowingAsync_ShouldReturnAvailableBooks()
        {
            // Arrange
            var books = _fixture.CreateMany<Book>(3).ToList();
            _bookRepositoryMock.Setup(r => r.GetAvailableForBorrowingAsync())
                .ReturnsAsync(books);

            // Act
            var result = await _service.GetAvailableForBorrowingAsync();
